...
if($_POST){
    ...
    && isset($_POST['nombre']) && !empty($_POST['nombre'])){
        ...
        $sql = 'UPDATE `liste` SET `libelle`=:libelle, `prix`=:prix, `nombre`=:nombre WHERE `id`=:id;';
            ...
            <section class="col-12">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="prix" name="prix" class="form-control" value="<?= $libelle['prix']?>">

                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="number" id="nombre" name="nombre" class="form-control" value="<?= $libelle['nombre']?>">
                    </div>
